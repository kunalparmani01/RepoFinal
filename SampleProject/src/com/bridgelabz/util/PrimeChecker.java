...
public class PrimeChecker {
	...
	/*
	 * JAVA STYLE GUIDE - CLASS STATIC VARIABLE DECLARATION STYLE NOTES - ALL
	 * STATIC VARIABLE SHOULD BE DECLARED IN THE TOP. FOR EVERY STATIC VARIABLE
	 * THERE NEEDS TO COMMENT - STATIC VARIABLE ARE DECLARED AS ALL CAPS
	 * SEPERATED BY _ IF MULTIPPLE WORD
	 */
	 ...
	 * CLASS VARIABLE SHOULD BE DECLARED IN THE TOP AFTER STATIC DICLARATION IF
	 * ANY. - CLASS MEMBER VARIABLE NAME STARTS WITH 'm' TO INDICATE CLASS
	 * VARIABLE. FOLLOWWED BY THE VARIABLE NAME IN CAMLE CASE - FOR EVERY CLASS
	 * VARIABLE THERE NEEDS TO BE A COMMENT DESRIBING THE NEED FOR THE VARIABLE
	 */
	 ...
	 * CONSTRUCTOR OR FUNCTION DECLARATION - FOR EVERY CONSTRUCTOR THERE NEEDS TO
	 * BE A COMMENT DESRIBING THE NEED
	 */
	...
	/*
	 * JAVA STYLE GUIDE - CLASS FUNCTION DECLARATION STYLE NOTES - CLASS FUNCTION
	 * IS DECLARED IMMEDIATELY AFTER CONSTRUCTOR - FOR EVERY FUNCTION THERE NEEDS
	 * TO BE A COMMENT DESRIBING THE PURPOSE - FUNCTION DECLARATION STARTS WITH A
	 * SMALL CASE AND THEN CAMEL CASE FOR EVERY WORD IN THE FUNCTION
	 */
	...
	/**
	 * return a string message describing the number is prime or not. This
	 * function overrides the toString function declared in the Object Class
	 *
	...
	/**
	 * Static Function to check for prime. This function is declared static
	 * because no initialization of clase PrimeChecker is needed if the number is
	...
	public static boolean checkPrime(long n) {
		...
		/*
		 * JAVA STYLE GUIDE - EVERY BLOCK NEEDS TO HAVE THE COMMENT NOTES - LEAVE
		 * SINGLE BLANK LINE AFTER EVERY LOOP - NO NEED FOR CURLY BRACES {} IF THE
	...
	public static void main(String[] args) {
		...
		// Only taking valid integer input. If Exception is thrown than not
		// procssing further.
		try {
